...
public class Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTextView = findViewById(R.id.timer_text3); // Ensure you have a TextView in your layout for this
    ...
    private void evaluateAnswerAndProceed() {
        ...
        Intent i1 = new Intent(getApplicationContext(), Question4.class); // Assuming there's a Question4 class next
