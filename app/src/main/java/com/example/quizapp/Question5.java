...
public class Question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTextView = findViewById(R.id.timer_text5); // Make sure you have a TextView in your layout for this
        ...
        db.collection("questions").document("question5")
                .get()
        ...
        next.setOnClickListener(v -> {
            if (countDownTimer != null) {
                countDownTimer.cancel(); // Cancel the timer if user presses next
            }
    ...
    private void evaluateAnswerAndProceed() {
        ...
        Intent i1 = new Intent(getApplicationContext(), Score.class); // Assuming Score is the final result activity
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (countDownTimer != null) {
            countDownTimer.cancel(); // Ensure the timer is cancelled when the activity is destroyed
        }
    }
}
