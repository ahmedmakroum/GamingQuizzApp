...
public class Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTextView = findViewById(R.id.timer_text4); // Ensure you have a TextView in your layout for this
        ...
        db.collection("questions").document("question4")
                .get()
    ...
    private void evaluateAnswerAndProceed() {
        ...
        Intent i1 = new Intent(getApplicationContext(), Question5.class); // Assuming there's a Question5 class next
